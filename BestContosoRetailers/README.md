...
- [ ] -view [bookId]    => given a bookId, shows the info for that book
- [ ] -order [bookId]    => “orders” a book by moving it from the “in stock” list to the “to be shipped” list
- [ ] -return [bookId]    => returns a book (moves it from the “to be shipped” list back to the “in stock” list)
